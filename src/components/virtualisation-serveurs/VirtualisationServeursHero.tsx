...
import { VirtualisationServeursHeroIcon } from "@/components/virtualisation-serveurs/VirtualisationServeursHeroIcon";
import { getVirtualisationServeurs } from "@/data/virtualisation-serveurs";
import { getLocale } from "@/lib/i18n/get-locale";
import { type } from "@/lib/typography";
import { cn } from "@/lib/utils";

export async function VirtualisationServeursHero() {
        ...
        <div className="relative mt-6 overflow-hidden border border-ink/15 bg-ink shadow-[0_24px_48px_-32px_rgba(16,24,32,0.55)]">
          ...
          <div className="relative flex flex-col items-start gap-8 px-6 py-10 sm:px-8 sm:py-12 md:flex-row md:items-center md:justify-between md:gap-10 lg:px-12 lg:py-14">
            ...
            <div
              ...
              aria-hidden
            >
              <VirtualisationServeursHeroIcon />
            </div>
          </div>
        </div>
