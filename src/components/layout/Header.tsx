...
function navClass(active: boolean) {
  return cn(
    "inline-flex items-center gap-1 whitespace-nowrap text-[13px] font-medium xl:gap-1.5 xl:text-[15px] 2xl:text-base",
              ...
              <span key={item.id} className="contents">
                ...
                >
                  ...
                  >
                    ...
                    <ChevronDown
                      className={cn(
                        "h-3.5 w-3.5 shrink-0 transition-transform xl:h-4 xl:w-4",
                        open && "rotate-180",
                      )}
                    />
                  </button>
